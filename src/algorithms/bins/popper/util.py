...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Hide information during learning",
    )
    parser.add_argument(
        "--debug",
        default=False,
...
def timeout(settings, func, args=(), kwargs={}, timeout_duration=1):
    ...
    try:
        ...
        # if type(e).__name__ == 'PrologError':
        #     # print(e)
        #     return result
        # var = (type(e).__name__)
        # print("test")
...
class Stats:
    ...
    def duration_summary(self):
        ...
        for operation, durations in stats:
            ...
            summary.append(
                DurationSummary(operation.title(), called, total, mean, maximum)
            )
        return summary
...
def rule_is_recursive(rule):
    ...
    if not head:
        return False
    return any(
        head.predicate == literal.predicate
        for literal in body
